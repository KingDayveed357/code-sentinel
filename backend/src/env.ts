...
const envSchema = z.object({
    ...
    AI_QUEUE_CONCURRENCY: z.string().optional(),
    AI_QUEUE_ATTEMPTS: z.string().optional(),
    AI_QUEUE_BACKOFF_MS: z.string().optional(),
    AI_EXPLANATION_CACHE_TTL_SECONDS: z.string().optional(),
