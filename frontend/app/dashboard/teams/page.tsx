...
export default function TeamsListPage() {
  ...
  const handleCreateTeam = async () => {
    ...
    try {
      setCreating(true);
      const result = await teamsApi.create({ name: teamName });
      setTeams([...teams, { team: result.team, role: "owner", memberCount: 1 }]);
            ...
            >
              <CardHeader>
                <CardTitle className="flex items-center justify-between">
                  ...
                  <Badge className={getRoleBadge(item.role).className}>
